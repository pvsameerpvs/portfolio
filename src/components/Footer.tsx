...
const Footer = () => {
  ...
  return (
    <motion.footer className="relative bg-gradient-to-b from-black to-gray-900 border-t border-white/10 py-8 md:py-12 overflow-hidden">
      {/* Background Elements */}
      ...
      >
        ...
        {/* <motion.div variants={itemVariants} className="text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Mohammed Sameer. All Rights Reserved.
          </p>
        </motion.div> */}
      </motion.div>
